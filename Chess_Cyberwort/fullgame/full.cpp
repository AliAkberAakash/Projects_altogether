...
bool logic(int a, int b, int c, int d)
{
    ...
    else if((block_rect[7][1].x==a&&block_rect[7][1].y==b)||(block_rect[7][6].x==a&&block_rect[7][6].y==b)||(block_rect[0][1].x==a&&block_rect[0][6].y==b)||(block_rect[0][1].x==a&&block_rect[0][6].y==b))
        state=bishoplogic(a,b,c,d);
