...
bool kingCheck2()
{
    ...
    if(rooklogic(block_rect[7][0].x, block_rect[7][0].y, block_rect[0][4].x, block_rect[0][4].y)||rooklogic(block_rect[7][7].x, block_rect[7][7].y, block_rect[0][4].x, block_rect[0][4].y))
        ...
        status=true;
    else if(bishoplogic(block_rect[7][2].x, block_rect[7][2].y, block_rect[0][4].x, block_rect[0][4].y)||bishoplogic(block_rect[0][5].x, block_rect[0][5].y, block_rect[7][4].x, block_rect[7][4].y))
        status=true;
    else
    for(int i=0; i<8; i++)
    {
