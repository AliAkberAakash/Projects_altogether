...
int player=1;
char active='n';
int valid1=0, valid2=0, kingvalid1=0, kingvalid2=0;
...
int buttonx(int a);
int buttony(int a);
int vqueenlogic(int a, int b, int c, int d);
...
bool kingCheck1();
bool kingCheck2();
bool checkfor1(int a, int b);
bool checkfor2(int a, int b);
...
void draw(){
        ...
        for(int i=0; i<640; i=i+80)
        {
            ...
            {
                if(kinglogic1(s,r,i,j)&&active=='y')
                {
                selected_rect.x=i;
                selected_rect.y=j;
                selected_rect.h=80;
            ...
            {
                if(kinglogic2(s,r,i,j)&&active=='y')
                {
                selected_rect.x=i;
                selected_rect.y=j;
                selected_rect.h=80;
...
//    {
//        if((!check1(400,560))&&block_rect[7][4].x==c&&block_rect[7][4].x)
//        {
//        go=true;
...
//    {
//        if((!check1(160,560))&&block_rect[7][4].x==c&&block_rect[7][4].x)
//        {
//        go=true;
...
//                    valid2++;
//                if(queenlogic(block_rect[7][4].x,block_rect[7][4].y,i,j)&&(!check1(i,j)))
//                    {
//                        if(checkfor2(i,j))
//                        valid1++;
//                    }
                if(kinglogic1(block_rect[7][4].x,block_rect[7][4].y,i,j)&&(!check1(i,j))&&(!checkfor1(i,j)))
                    {
                        valid1++;
                        //valid1++;
                    }
                if(kinglogic2(block_rect[0][4].x,block_rect[0][4].y,i,j)&&(!check2(i,j))&&(!checkfor2(i,j)))
                    {
                        //kingvalid2++;
                        valid2++;
                    }
        ...
        if(queenlogic(block_rect[0][3].x, block_rect[0][3].y, block_rect[7][4].x, block_rect[7][4].y))
                {
                    vqueenlogic(block_rect[0][3].x, block_rect[0][3].y, block_rect[7][4].x, block_rect[7][4].y);
                }

        //cout<<kingvalid1<<" "<<kingvalid2<<endl;
        cout<<valid1<<endl;

        if((!valid1)&&checked1)
           cout<<"player one looses"<<endl;

        if((!kingvalid2)&&checked2)
...
//        status=true;
    ...
    for(int m=0; i<m; i++)
        {
             if(b_pawnlogic(block_rect[1][m].x, block_rect[1][m].y,i,j))
                status=true;
        }
