...
int player=1;
char active='n';
char bk='u', wk='u', br1='u', br2='u',wr1='u', wr2='u';
int p=0,q=0,s=-1,r=-1;
    ...
    if(e.type==SDL_KEYDOWN)
    {
        ...
        const Uint8 *keystate = SDL_GetKeyboardState(NULL);
                            ...
                            q=selector_rect.y;
                                if(active=='y')
                                {
                                    if(logicP1(s, r, selector_rect.x, selector_rect.y)&&(!check1(p,q)))
                                      {
    ...
    if(e.type==SDL_KEYDOWN)
    {
        ...
        const Uint8 *keystate = SDL_GetKeyboardState(NULL);
                            ...
                            q=selector_rect.y;
                                ...
                                if(active=='y')
                                {
                                    if(logicP2(s, r, selector_rect.x, selector_rect.y)&&(!check2(p,q)))
                                      {
...
bool bishoplogic(int a, int b, int c, int d)
{
    ...
    {
        for(i=c+80, j=b+80; i<a; i=i+80, j=j+80)
        {
    ...
    {
        for(i=a+80, j=d+80; i<c; i=i+80, j=j+80)
        {
...
//{
//    int t,o;
//    if(a==block_rect[7][0].x&&b==block_rect[7][0].y&&wk=='u'&&wr1=='u')
//    {
//        t=block_rect[7][0].x;
//        o=block_rect[7][0].y;
//        block_rect[7][0].x=block_rect[7][4].x;
//        block_rect[7][0].y=block_rect[7][4].y;
//        block_rect[7][4].x=t;
//        block_rect[7][4].y=o;
//    }
//}
