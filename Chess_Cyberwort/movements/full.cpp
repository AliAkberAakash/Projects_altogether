...
bool logic(int a, int b,int c, int d);
bool pawnlogic(int a, int b, int c, int d);
...
// INITIALIZATION OF BLOCKS
    ...
    selected=IMG_Load("selected.png");
    ...
    if(e.type==SDL_KEYDOWN)
    {
        ...
        const Uint8 *keystate = SDL_GetKeyboardState(NULL);
                            ...
                            q=selector_rect.y;
                                if(active=='y')
                                {
                                    if(logic(s, r, selector_rect.x, selector_rect.y))
                                      {
...
bool logic(int a, int b, int c, int d)
{
    ...
    for(int i=0; i<8; i++)
    {
        if((block_rect[6][i].x==a&&block_rect[6][i].y==b)||(block_rect[1][i].x==a&&block_rect[1][i].y==b))
            state=pawnlogic(a,b,c,d);
    }

    if((block_rect[7][2].x==a&&block_rect[7][2].y==b)||(block_rect[7][5].x==a&&block_rect[7][5].y==b)||(block_rect[0][2].x==a&&block_rect[0][2].y==b)||(block_rect[0][5].x==a&&block_rect[0][5].y==b))
    state=bishoplogic(a,b,c,d);

    else if((block_rect[7][1].x==a&&block_rect[7][1].y==b)||(block_rect[7][6].x==a&&block_rect[7][6].y==b)||(block_rect[0][6].x==a&&block_rect[0][6].y==b)||(block_rect[0][1].x==a&&block_rect[0][1].y==b))
        state=knightlogic(a,b,c,d);

    else if((block_rect[7][3].x==a&&block_rect[7][3].y==b)||(block_rect[0][3].x==a&&block_rect[0][3].y==b))
            state=true;

    else if((block_rect[7][4].x==a&&block_rect[7][4].y==b)||(block_rect[0][4].x==a&&block_rect[0][4].y==b))
            state=kinglogic(a,b,c,d);

    else if((block_rect[7][0].x==a&&block_rect[7][0].y==b)||(block_rect[7][7].x==a&&block_rect[7][7].y==b)||(block_rect[0][0].x==a&&block_rect[0][0].y==b)||(block_rect[0][7].x==a&&block_rect[0][7].y==b))
